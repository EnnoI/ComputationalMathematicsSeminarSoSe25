...
def solve_ambplus_2D(phi_0=None, c_0=0.4, t_state=0.0, t_len = 100.0, tau = 0.01, eps_val=1., a=-0.25, b=0.25, lam_val=0.5 , zeta= 1.0 , D=0.05, M=1., s_start = -32.*np.pi, s_end = 32.*np.pi, s_N = 200):
...
def main():
    ...
    solve_ambplus_2D(phi_0, c_0=0.6, s_N=N, tau=0.02, t_len=195000, D=0.0, lam_val= 0.5 , zeta= 1.0 , s_start=-64, s_end=64)
